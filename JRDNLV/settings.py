"""
Django settings for JRDNLV project on Heroku. Fore more info, see:
...
SECRET_KEY = "#u80l3q21#mzdv^vf3068lcf8@hltxgz7y3tdg(mvdwgg-tovn"
...
WSGI_APPLICATION = 'JRDNLV.wsgi.application'
